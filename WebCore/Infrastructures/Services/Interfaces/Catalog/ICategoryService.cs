...
namespace WebCore.Infrastructures.Services.Interfaces.Catalog
{
    public interface ICategoryService
    {
        ...
        //void DeleteCategories(IList<int> ids);
        ...
        //void DeleteAllProductCategoryMappingsByProductId(int productId);
    }
}
